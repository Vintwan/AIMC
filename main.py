...
# 上部分：图像描述
tk.Label(top_frame, text="图像描述", anchor="w", font=("Arial", 12)).pack(fill="x")
...
tk.Label(middle_frame, text="描述精简", anchor="w", font=("Arial", 12)).pack(fill="x")
tk.Label(middle_frame, text="使用模型", anchor="w").pack(fill="x")
...
tk.Label(middle_frame, text="处理文件名", anchor="w").pack(fill="x")
...
tk.Label(bottom_frame, text="描述整合", anchor="w", font=("Arial", 12)).pack(fill="x")
tk.Label(bottom_frame, text="使用模型", anchor="w").pack(fill="x")
...
tk.Label(bottom_frame, text="处理文件名", anchor="w").pack(fill="x")
...
# 开始运行按钮
tk.Button(root, text="开始运行", command=start_processing).pack()
